...
public class Level {
    ...
    //this will hold all the instances of GameObjects
    private ArrayList<GameObject> objects;

    public Level(Context context, PointF mScreenSize, GameEngine ge){
        objects = new ArrayList<>();
        GameObjectFactory factory = new GameObjectFactory(context,
                mScreenSize, ge);
    ...
    ArrayList<GameObject> buildGameObjects(GameObjectFactory factory){
        ...
        objects.add(PLAYER_INDEX, factory.create(new PlayeSpec()));
